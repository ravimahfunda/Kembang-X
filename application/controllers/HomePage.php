...
class HomePage extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['lpromos']= $this->db->query("select p.IMAGE, r.ID_PROMO, p.ID_PLACE, p.TITLE, r.COST ,r.UNTIL, r.QUOTA, r.HEADLINE, r.DESCRIPTION from PROMOS r, PLACES p where r.ID_PLACE=p.ID_PLACE and QUOTA > 0 and UNTIL >= SYSDATE")->result();
